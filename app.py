...
tab_danalytics, tab_dend, tab_dsor, tab_perf, tab_qands, tab_workforce, tab_igov = st.tabs(tab_list)
...
df_list = [danalytic_df, dend_df, dsor_df, perf_df, qands_df, workforce_df, igov_df]
